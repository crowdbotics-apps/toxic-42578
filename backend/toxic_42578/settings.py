"""
Django settings for toxic_42578 project.
...
WSGI_APPLICATION = 'toxic_42578.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "toxic_42578 API",
    "DESCRIPTION": "API documentation for toxic_42578 App",
    "VERSION": "v1",
}
